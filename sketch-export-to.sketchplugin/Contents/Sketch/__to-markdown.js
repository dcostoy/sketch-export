...
/* WEBPACK VAR INJECTION */(function(fetch) {/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ "./node_modules/@babel/runtime/helpers/asyncToGenerator.js");
...
var exportTo = function exportTo(context, fileType, fileMarkup) {
  ...
  var runSaveFileDialog = function runSaveFileDialog(pageLayers, artboard, previewOnline) {
    ...
    console.error("Result: ", resultSaveDialog); // result
  ...
  var parseContent = /*#__PURE__*/function () {
    var _ref = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee(pageLayers, artboard, directoryPath, file) {
      var content;
...
var addMarkdownSyntax = function addMarkdownSyntax(layerName, layer, directoryPath) {
  ...
  switch (layerName) {
    ...
    default:
      var otherTxtContext = getFontDecorationMd(layer);
      layerMd += "".concat(otherTxtContext).concat(layer.text.trim()).concat(otherTxtContext, "\n\n");
      break;
  }
...
/* harmony import */ var _md__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./md */ "./src/parse-layers/md.js");
/* harmony import */ var _json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./json */ "./src/parse-layers/json.js");
...
var getParsedContent = /*#__PURE__*/function () {
  var _ref = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.mark(function _callee(allLayers, artboardName, directoryPath, fileType) {
          ...
          case 0:
            ...
            contentprocessLayers = function contentprocessLayers(layer) {
              ...
              if (layer.type === "Group" && !layer.name.match(/^image-/)) {
                var layerLayersReversed = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(layer.layers).reverse();

                layerLayersReversed.map(function (layer) {
                  contentprocessLayers(layer);
                });
              } else {
                if (fileType === "md") {
                  contentParsedMd += Object(_md__WEBPACK_IMPORTED_MODULE_3__["default"])(layer.name, layer, directoryPath);
                } else if (fileType === "json") {
                  var obj = Object(_json__WEBPACK_IMPORTED_MODULE_4__["default"])(layer.name, layer, directoryPath);
...
//# sourceMappingURL=__to-markdown.js.map